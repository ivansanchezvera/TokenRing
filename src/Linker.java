...
//This class allows to link a given set of processes with each other.
//Helps to start n processes P1,P2...Pn in a distributed system and establish
//connections between by send/receive of messages
public class Linker {
	...
	public Msg receiveMsg(int fromId) throws IOException {
		...
		System.out.println(" received nessage " + getline);
